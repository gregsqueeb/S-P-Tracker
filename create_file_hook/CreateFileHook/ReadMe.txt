========================================================================
    DYNAMIC LINK LIBRARY: CreateFileHook-Projektübersicht
========================================================================

Diese CreateFileHook-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CreateFileHook-Anwendung besteht.


CreateFileHook.vcxproj
...
CreateFileHook.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CreateFileHook.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
